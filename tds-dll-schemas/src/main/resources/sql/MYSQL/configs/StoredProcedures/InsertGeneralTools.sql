...
BEGIN
	...
	WHERE context = v_assessmentId AND clientname = v_clientname AND type != 'Language' AND type != 'Print Size';
	...
	INSERT IGNORE INTO configs.client_testtool (
		...
		v_clientname, 'Global Notes', 'TDS_GN0', 'Global Notes Off', b'0', b'0', 'Global Notes Off', 
		v_assessmentId, -1, 'FairwayToolScript', 'FairwayToolScript', 'TEST', 'ALL', NULL
	), (
		v_clientname, 'Global Notes', 'TDS_GN1', 'Global Notes On', b'1', b'0', 'Global Notes On', 
		v_assessmentId, 1, 'FairwayToolScript', 'FairwayToolScript', 'TEST', 'ALL', NULL
	), (
	...
	(
		v_assessmentId, 'TEST', 'Language', 'ENU-Braille', b'1', 'Emboss Request Type', 'TDS_ERT_OR&TDS_ERT_Auto', v_clientname,  UNHEX(REPLACE(UUID(),'-','')), 'ALL'),
	(
		v_assessmentId, 'TEST', 'Language', 'ESN', b'0', 'Mark for Review', 'TDS_MfR0', v_clientname,  UNHEX(REPLACE(UUID(),'-','')), 'ALL'),
	(
		v_assessmentId, 'TEST', 'Language', 'ENU-Braille', b'1', 'Braille Type', 'TDS_BT_NM', v_clientname,  UNHEX(REPLACE(UUID(),'-','')), 'ALL'),
	(
