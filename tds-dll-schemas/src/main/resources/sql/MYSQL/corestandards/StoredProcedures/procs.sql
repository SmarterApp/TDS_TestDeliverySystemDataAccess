...
DROP PROCEDURE IF EXISTS editpublisher $$

CREATE PROCEDURE `editpublisher`(IN v_publisherName VARCHAR(255)
,IN v_publisherKey VARCHAR(255), IN v_new_publisherName VARCHAR(255))
BEGIN
update publisher set name=v_new_publisherName where name=v_publisherName and _key=v_publisherKey;
END$$
DELIMITER ;
...
CREATE PROCEDURE `deletegrade` (IN v_gradeName VARCHAR(255)
,IN v_gradeKey VARCHAR(255))

BEGIN
delete from gradelevel where name=v_gradeName and _key=v_gradeKey;
END$$
...
CREATE PROCEDURE `editgrade` (IN v_gradeName VARCHAR(255)
,IN v_gradeKey VARCHAR(255), IN v_new_gradeName VARCHAR(255))

BEGIN
update gradelevel set name=v_new_gradeName where name=v_gradeName and _key=v_gradeKey;
END$$
...
CREATE PROCEDURE `deletesubject` (IN v_subjectName VARCHAR(255)
,IN v_subjectKey VARCHAR(255))

BEGIN
delete from subject where name=v_subjectName and _key=v_subjectKey;
END$$
...
DROP PROCEDURE IF EXISTS editsubject $$

CREATE PROCEDURE `editsubject` (IN v_subjectName VARCHAR(255)
,IN v_subjectKey VARCHAR(255)
,IN v_new_subjectName VARCHAR(255))

BEGIN
update subject set name=v_new_subjectName where name=v_subjectName and _key=v_subjectKey;
END$$
DELIMITER ;
