...
CREATE TABLE `loader_initialize` (
    ...
    -- ,CONSTRAINT `fk_sessionkey_linitialize` 
...
CREATE TABLE `loader_benchmarkgrades` (
    ...
    -- ,CONSTRAINT `fk_sessionkey_lbenchmarkgrades` 
    -- FOREIGN KEY (`_fk_sessionkey`)
    --    REFERENCES `session` (`_key`)
    --    ON DELETE CASCADE
)  ENGINE=INNODB DEFAULT CHARSET=UTF8;
...
CREATE TABLE `loader_errors` (
    ...
    `_fk_sessionkey` CHAR(32)
    -- ,CONSTRAINT `fk_sessionkey_lerrors` 
    -- FOREIGN KEY (`_fk_sessionkey`)
    --   REFERENCES `session` (`_key`)
    --    ON DELETE CASCADE
)  ENGINE=INNODB DEFAULT CHARSET=UTF8;
...
CREATE TABLE `loader_categories` (
    ...
    `_fk_sessionkey` CHAR(32)
    -- ,CONSTRAINT `fk_sessionkey_lcategories` 
    -- FOREIGN KEY (`_fk_sessionkey`)
    --    REFERENCES `session` (`_key`)
    --    ON DELETE CASCADE
)  ENGINE=INNODB DEFAULT CHARSET=UTF8;
...
CREATE TABLE `loader_publication` (
    ...
    `_fk_sessionkey` CHAR(32)
    -- ,CONSTRAINT `fk_sessionkey_lpublication` 
    -- FOREIGN KEY (`_fk_sessionkey`)
    --    REFERENCES `session` (`_key`)
    --    ON DELETE CASCADE
)  ENGINE=INNODB DEFAULT CHARSET=UTF8;
...
CREATE TABLE `loader_socks` (
    ...
    `_fk_sessionkey` CHAR(32)
    -- ,CONSTRAINT `fk_sessionkey_lsocks` 
    -- FOREIGN KEY (`_fk_sessionkey`)
    --    REFERENCES `session` (`_key`)
    --    ON DELETE CASCADE
)  ENGINE=INNODB DEFAULT CHARSET=UTF8;
...
CREATE TABLE `loader_standard_relationship` (
    ...
    `_fk_sessionkey` CHAR(32)
    -- ,CONSTRAINT `fk_sessionkey_lstandard_relationship` 
    -- FOREIGN KEY (`_fk_sessionkey`)
    --    REFERENCES `session` (`_key`)
    --    ON DELETE CASCADE
)  ENGINE=INNODB DEFAULT CHARSET=UTF8;
...
CREATE TABLE `loader_standards` (
    ...
    `_fk_sessionkey` CHAR(32)
    -- ,CONSTRAINT `fk_sessionkey_lstandards` 
    -- FOREIGN KEY (`_fk_sessionkey`)
    --    REFERENCES `session` (`_key`)
    --    ON DELETE CASCADE
)  ENGINE=INNODB DEFAULT CHARSET=UTF8;
...
CREATE TABLE `publication` (
    ...
    PRIMARY KEY (`_key`)
    -- ,CONSTRAINT `fk_publicationpublisher`, 
    -- FOREIGN KEY (`_fk_publisher`)
    --    REFERENCES `publisher` (`_key`)
    --    ON DELETE NO ACTION ON UPDATE CASCADE,
    -- CONSTRAINT `fk_publicationsubject` 
